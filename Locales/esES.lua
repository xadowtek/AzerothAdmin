...
--[[General]]
  ...
  --[[Other]]
    ...
    ["ma_parameters"]                 = "Valor(es):", --Used on multiple tabs
...
--[[GM tab]]
  --[[Name]]
    ["tabmenu_Main"]                  = "GM",
  --[[Tooltips]]
    ["tt_MainButton"]                 = "Activa la pestaña opciones de GM.",
    ["tt_DisplayAccountLevel"]        = "Muestra el nivel de cuenta",
    ...
    ["tt_ScreenButton"]               = "Hace una captura de pantalla",
    ["tt_BankButton"]                 = "Abre el banco.",
  ...
  --[[Control Labels]]
    ["ma_OffButton"]                  = "Off",
    ["ma_displaylevelbutton"]         = "Nivel Cuenta",
    ...
    ["ma_acctdelete"]                 = "Borrar Cuenta",
    ["ma_acctaddon"]                  = "Acct Addon",
    ["ma_acctgmlvl"]                  = "Nivel GM",
...
--[[Char Tab]]
  --[[Name]]
    ["tabmenu_Char"]                  = "Jugador",
    ["tt_CharButton"]                 = "Activa la pestaña opciones de jugadores.",
  --[[Tooltips]]
...
--[[NPC Tab]]
  --[[Name]]
    ["tabmenu_NPC"]                   = "NPC",
    ["tt_NpcButton"]                  = "Activa la pestaña opciones de npc's.",
  --[[Tooltips]]
...
--[[GObjects Tab]]
  --[[Name]]
    ["tabmenu_GO"]                    = "Items",
    ["tt_GOButton"]                   = "Activa la pestaña opciones de objetos de juego (GOB).",
  --[[Tooltips]]
...
--[[Tele Tab]]
  --[[Name]]
    ...
    ["tt_TeleButton"]                 = "Altiva la pestaña opciones de teleport.",
  --[[Tooltips]]
  --[[Control Labels]]
...
--[[Tickets Tab]]
  --[[Name]]
    ...
    ["tt_TicketButton"]               = "Activa la pestaña tickets de jugadores.",
  --[[Tooltips]]
...
--[[Misc Tab]]
  --[[Name]]
    ["tabmenu_Misc"]                  = "Opciones",
    ["tt_MiscButton"]                 = "Activa la pestaña de opciones panel admin.",
  --[[Tooltips]]
...
--[[Server Tab]]
    ...
    ["tt_ServerButton"]               = "Activa la pestaña de informacion del servidor.",
  --[[Tooltips]]
    ["tt_AnnounceButton"]             = "Enviar mensaje de sistema",
    ["tt_ShutdownButton"]             = "Shut down the server in the amount of seconds from the field, if omitted shut down immediately!",
  --[[Control Labels]]
    ["ma_AnnounceButton"]             = "Enviar",
...
--[[Log Tab]]
    ["tabmenu_log"]                   = "Logs",
    ["tt_LogButton"]                  = "Activa la pestaña de Logging.",
  --[[Tooltips]]
  --[[Control Labels]]
  --[[Other]]
...
--[[Who Tab]]
    ["tabmenu_who"]                   = "Online",
    ["tt_whotabmenubutton"]           = "Activa la pestaña opciones de jugadores online.",
  --[[Tooltips]]
    ["tt_who_customize"]              = "Activa personalizacion en el siguiente login.",
    ["tt_who_chardelete"]             = "PELIGRO! Borra el personaje. PELIGRO!",
    ["tt_who_charrename"]             = "Activa cambio de nombre en el siguiente login.",
    ["tt_who_permbanbutton"]          = "Banea al jugador PERMANENTEMENTE",
    ["tt_who_1daybanbutton"]          = "Banea al jugador por un dia",
    ["tt_who_jailabutton"]            = "Envia jugador la jaula (Alianza)",
    ["tt_who_jailhbutton"]            = "Envia jugador la jaula (Horda)",
    ["tt_who_unjailbutton"]           = "Recupera jugador de la jaula",
  --[[Control Labels]]
    ["ma_ShowWhoButton"]              = "Refrescar",
    ["ma_resetwhobutton"]             = "Reset",
    ["ma_acctdetail"]                 = "Acct:",
    ["ma_chardetail"]                 = "Char:",
    ["ma_whisperbutton"]              = "Susurro",
    ["ma_SummonWhoButton"]            = "Trasladar",
    ["ma_GoCharWhoButton"]            = "Aparecer",
    ["ma_AnswerWhoButton"]            = "Correo",
    ["ma_who_customize"]              = "Personalizar",
    ["ma_who_chardelete"]             = "|c00FF0000Borrar PJ|r",
    ["ma_who_charrename"]             = "Renombrar",
    ["ma_DeleteWhoButton"]            = "Expulsar",
    ["ma_who_1daybanbutton"]          = "Banear 1D",
    ["ma_who_permbanbutton"]          = "Banear",
    ["ma_who_jailabutton"]            = "Jaula (A)",
    ["ma_who_jailhbutton"]            = "Jaula (H)",
    ["ma_who_unjailbutton"]           = "Quitar Jaula",
  --[[Other]]
...
--[[Pop UPs]]
  ...
  --[[Labels]]
    ["ma_ItemButton"]                 = "» Items «",
    ["ma_ItemSetButton"]              = "» Items Set «",
    ["ma_SpellButton"]                = "» Spell's «",
    ["ma_QuestButton"]                = "» Quest «",
    ["ma_CreatureButton"]             = "» Criaturas «",
    ["ma_ObjectButton"]               = "» Objetos «",
    ["ma_TeleSearchButton"]           = "» Teleport «",
    ["ma_MailRecipient"]              = "",
    ["ma_Mail"]                       = "Enviar Mail",
    ["ma_Send"]                       = "Enviar",
    ...
    ["ma_FavAdd"]                     = "Añadir",
    ["ma_FavRemove"]                  = "Borrar",
    ["ma_SelectAllButton"]            = "Marcar todo",
    ["ma_DeselectAllButton"]          = "Quitar todo",
    ["ma_MailBytesLeft"]              = "Bytes : ",
    ["ma_SkillButton"]                = "» Skill's «",
    ...
    ["ma_NoFavorites"]                = "No hay favoritos guardados!",
